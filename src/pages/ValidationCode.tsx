    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="bg-white p-4 flex justify-between items-center shadow-sm">
        <div className="flex items-center">
          ...
          <span className="font-bold text-sportybet-red">Validation</span>
        </div>
      ...
      <div className="flex-1 p-6 flex flex-col items-center justify-center">
        <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
          <h1 className="text-xl font-bold mb-6 text-center text-sportybet-red">Enter Password</h1>
          ...
          <Input
            ...
            className="mb-5 border-2 border-red-100 focus:border-sportybet-red"
          />
