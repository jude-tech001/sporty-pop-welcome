    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="bg-white p-4 flex justify-between items-center shadow-sm">
        <div className="flex items-center">
          ...
          <span className="font-bold text-sportybet-red">Add Balance</span>
        </div>
        <div className="flex-1"></div>
        <div className="text-red-500 text-sm font-medium">The official</div>
      </div>
      
      {/* Main Content */}
      <div className="flex-1 p-6 flex flex-col items-center">
        <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
          <h1 className="text-2xl font-bold mb-6 text-center text-sportybet-red">Welcome!</h1>
          ...
          <select 
            ...
            className="w-full mb-5 border-2 border-red-100 rounded-md px-3 py-2 h-10 text-base focus:outline-none focus:border-sportybet-red"
          >
